...
export class ArM5ePCActorSheetV2 extends Arm5eCharacterActorSheetV2 {
  ...
  static PARTS = {
    header: {
      template: `systems/${ARM5E.SYSTEM_ID}/templates/actor/parts/actor-pc-header-v2.hbs`
    },
    tabs: {
    ...
    description: {
      template: `systems/${ARM5E.SYSTEM_ID}/templates/actor/parts/actor-pc-description-tab-v2.hbs`
    },
    abilities: {
    ...
    footer: {
      template: `systems/${ARM5E.SYSTEM_ID}/templates/actor/parts/actor-pc-footer-v2.hbs`
    }
  };
