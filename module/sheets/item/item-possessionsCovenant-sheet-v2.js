...
/**
 * AppV2 sheet for possessionsCovenant items.
 */
export class ArM5ePossessionsCovenantItemSheetV2 extends ArM5eItemSheetV2 {
  /** @override */
  ...
  static PARTS = {
    header: {
      template: `systems/${ARM5E.SYSTEM_ID}/templates/item/parts/item-possessionsCovenant-header-v2.hbs`
    },
    tabs: {
