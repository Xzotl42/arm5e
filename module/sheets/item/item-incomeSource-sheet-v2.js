...
/**
 * AppV2 sheet for incomingSource items.
 */
export class ArM5eIncomeSourceItemSheetV2 extends ArM5eItemSheetV2 {
  /** @override */
  ...
  static PARTS = {
    header: {
      template: `systems/${ARM5E.SYSTEM_ID}/templates/item/parts/item-incomingSource-header-v2.hbs`
    },
    tabs: {
