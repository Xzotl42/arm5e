 ...
 */
export class ArM5eArtItemSheetV2 extends ArM5eItemSheetV2 {
  /** @override */
  static DEFAULT_OPTIONS = {
    classes: ["arm5e", "sheet", "item"],
    position: { width: 650, height: 600 },
    actions: {
      increaseScore: ArM5eArtItemSheetV2.increaseScore,
      decreaseScore: ArM5eArtItemSheetV2.decreaseScore
    }
  };
