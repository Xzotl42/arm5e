...
/**
 * AppV2 sheet for flaw items.
 */
export class ArM5eFlawItemSheetV2 extends ArM5eItemSheetV2 {
  /** @override */
  ...
  static PARTS = {
    header: {
      template: `systems/${ARM5E.SYSTEM_ID}/templates/item/parts/item-virtue-header-v2.hbs`
    },
    tabs: {
