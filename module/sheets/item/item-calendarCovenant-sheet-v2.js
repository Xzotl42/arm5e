...
/**
 * AppV2 sheet for calendarCovenant items.
 */
export class ArM5eCalendarCovenantItemSheetV2 extends ArM5eItemSheetV2 {
  ...
  static PARTS = {
    header: {
      template: `systems/${ARM5E.SYSTEM_ID}/templates/item/parts/item-calendarCovenant-header-v2.hbs`
    },
    tabs: {
