...
/**
 * AppV2 sheet for inferiority items.
 */
export class ArM5eInferiorityItemSheetV2 extends ArM5eItemSheetV2 {
  /** @override */
  ...
  static PARTS = {
    header: {
      template: `systems/${ARM5E.SYSTEM_ID}/templates/item/parts/item-inferiority-header-v2.hbs`
    },
    tabs: {
