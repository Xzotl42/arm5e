...
export class ArM5eVisSourcesCovenantItemSheetV2 extends ArM5eItemSheetV2 {
  ...
  static PARTS = {
    header: {
      template: `systems/${ARM5E.SYSTEM_ID}/templates/item/parts/item-visSourcesCovenant-header-v2.hbs`
    },
    tabs: {
    ...
    attributes: {
      template: `systems/${ARM5E.SYSTEM_ID}/templates/item/parts/item-visSourcesCovenant-attributes-v2.hbs`
    },
    footer: {
