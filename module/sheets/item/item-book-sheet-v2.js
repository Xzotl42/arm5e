...
export class ArM5eBookItemSheetV2 extends ArM5ePhysicalItemSheetV2 {
  ...
  static PARTS = {
    header: {
      template: `systems/${ARM5E.SYSTEM_ID}/templates/item/parts/item-book-header-v2.hbs`
    },
    tabs: {
    ...
    description: {
      template: `systems/${ARM5E.SYSTEM_ID}/templates/item/parts/item-book-description-v2.hbs`
    },
    enchantments: {
