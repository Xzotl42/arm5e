...
/**
 * AppV2 sheet for reputation items.
 */
export class ArM5eReputationItemSheetV2 extends ArM5eItemSheetV2 {
  /** @override */
  static DEFAULT_OPTIONS = {
    classes: ["arm5e", "sheet", "item"],
    position: { width: 500, height: 600 },
    actions: {
      increaseScore: ArM5eReputationItemSheetV2.increaseScore,
      decreaseScore: ArM5eReputationItemSheetV2.decreaseScore,
  ...
  static PARTS = {
    header: {
      template: `systems/${ARM5E.SYSTEM_ID}/templates/item/parts/item-reputation-header-v2.hbs`
    },
    tabs: {
